        ...
        <div className="relative w-full py-8 sm:py-12 md:py-16">
          <div className="flex md:flex-row flex-col gap-6 md:gap-12 items-start justify-between max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <div className="flex-1 w-full max-w-2xl px-3 sm:px-4 md:px-6">
              ...
              <div
                className="mt-3 sm:mt-4 md:mt-6 prose prose-blue max-w-none text-gray-600 leading-relaxed text-sm sm:text-base"
              ...
              <div className="mt-6 sm:mt-8 md:mt-12">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {courseData.courseContent?.map((chapter, index) => (
                    <div
                      key={index}
                      className="border-2 border-gray-100 bg-white rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300"
                    >
                      <button
              ...
              <div className="py-12 sm:py-16 md:py-24">
                ...
                <div
                  className="pt-4 rich-text leading-relaxed text-sm sm:text-base"
                  dangerouslySetInnerHTML={{
            ...
            <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
              ...
              <div className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
                ...
                <button
                  ...
                  className="w-full py-3 sm:py-4 px-4 sm:px-6 bg-blue-600 text-white font-semibold rounded-xl sm:rounded-2xl hover:bg-blue-700 transform hover:scale-[1.02] transition-all duration-300 shadow-md hover:shadow-xl text-sm sm:text-base"
                >
